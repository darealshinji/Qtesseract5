...
Level 3: Level 2, Convert files names, Dialog creation info, List of the texts to check"))
    ...
    def TesseractPath(self, Gui=False, Folder=None):
        ...
        if not Folder or Folder == "Auto":
            ...
            ### Il y a eu un changement de dossier à priori du dossier des langues...
            elif Path("/usr/share/tesseract-ocr/tessdata/eng.traineddata").exists():
                Folder = "/usr/share/tesseract-ocr/tessdata/"
